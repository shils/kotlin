...
private fun DeclarationDescriptorWithVisibility.isVisible(
    ...
    if (receiverExpression != null) {
        val receiverType = bindingContext.getType(receiverExpression) ?: return true
        val explicitReceiver = ExpressionReceiver(receiverExpression, receiverType)
        ...
        for (implicitReceiver in implicitReceivers) {
            val normalizeReceiver = ExpressionTypingUtils.normalizeReceiverValueForVisibility(implicitReceiver.value, bindingContext)
